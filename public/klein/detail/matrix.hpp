...
inline void KLN_VEC_CALL mat4x4_12(__m128 const& b,
                                   __m128 const* c,
                                   __m128* out) noexcept
{
    ...
    __m128 tmp
        = _mm_mul_ps(KLN_SWIZZLE(b, 0, 1, 2, 3), KLN_SWIZZLE(b, 0, 3, 3, 3));
    ...
    c2         = _mm_add_ps(
        c2, _mm_mul_ps(KLN_SWIZZLE(b, 0, 0, 0, 1), KLN_SWIZZLE(b, 0, 0, 3, 3)));
    ...
    {
        c3 = _mm_mul_ps(KLN_SWIZZLE(b, 1, 0, 0, 0), KLN_SWIZZLE(*c, 0, 3, 2, 1));
        c3 = _mm_add_ps(
            c3,
            _mm_mul_ps(KLN_SWIZZLE(b, 0, 2, 3, 1), KLN_SWIZZLE(*c, 0, 1, 3, 2)));
        c3 = _mm_add_ps(
            c3,
            _mm_mul_ps(KLN_SWIZZLE(b, 3, 1, 2, 3), KLN_SWIZZLE(*c, 0, 0, 0, 0)));
        tmp = _mm_mul_ps(KLN_SWIZZLE(b, 0, 3, 1, 2), KLN_SWIZZLE(*c, 0, 2, 1, 3));
