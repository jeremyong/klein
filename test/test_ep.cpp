...
TEST_CASE("multivector-ep")
{
    ...
    SUBCASE("plane^point")
    {
        ...
        entity<0b100> p1p2 = p1 ^ p2;
        CHECK_EQ(p1p2.e021(), 0.f);
        CHECK_EQ(p1p2.e013(), 0.f);
        CHECK_EQ(p1p2.e032(), 0.f);
    ...
    SUBCASE("line^line")
    {
        ...
        CHECK_EQ(l1l2.e12(), 0.f);
        CHECK_EQ(l1l2.e31(), 0.f);
        CHECK_EQ(l1l2.e23(), 0.f);
    ...
    SUBCASE("line^point")
    {
        ...
        CHECK_EQ(l1p2.e021(), 0.f);
        CHECK_EQ(l1p2.e013(), 0.f);
        CHECK_EQ(l1p2.e032(), 0.f);
